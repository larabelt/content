...
@include('belt-docs::partials.image', [
    'src' => '20/admin/content/assets/list-manager-airlines.png',
    'caption' => '',
])
...
@include('belt-docs::partials.image', [
    'src' => '20/admin/content/assets/list-editor-airlines.png',
    'caption' => '',
])
...
@include('belt-docs::partials.image', [
    'src' => '20/admin/content/assets/unlink-attachments.png',
    'caption' => '',
])