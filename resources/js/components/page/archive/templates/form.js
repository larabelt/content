        ...
        <form role="form">
            <div class="box-body">
                ...
                <div class="form-group" v-bind:class="{ 'has-error': errors.name }">
                    ...
                    <span class="help-page" v-show="errors.name">{{ errors.name }}</span>
                </div>
                <div v-if="item.id" class="form-group" v-bind:class="{ 'has-error': errors.slug }">
                    ...
                    <span class="help-page" v-show="errors.slug">{{ errors.slug }}</span>
                </div>
                <div class="form-group" v-bind:class="{ 'has-error': errors.body }">
                    ...
                    <span class="help-page" v-show="errors.body">{{ errors.body }}</span>
                </div>
            </div>
